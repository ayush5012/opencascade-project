...
public:
    ...
    void setupUi(QMainWindow *occQtClass)
    {
        ...
        actionopen = new QAction(occQtClass);
        actionopen->setObjectName(QString::fromUtf8("actionopen"));
        actionsave = new QAction(occQtClass);
    ...
    void retranslateUi(QMainWindow *occQtClass)
    {
        ...
        actionopen->setText(QCoreApplication::translate("occQtClass", "open", nullptr));
        actionsave->setText(QCoreApplication::translate("occQtClass", "save", nullptr));
